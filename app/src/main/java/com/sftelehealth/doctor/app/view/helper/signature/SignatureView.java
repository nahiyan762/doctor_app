package com.sftelehealth.doctor.app.view.helper.signature;
...
public class SignatureView extends View {
    ...
    private OnPenMovedListener onPenMovedListener;
    ...
    //code added by Rahul Thakur

    public void setPenMovedListener(OnPenMovedListener penMovedListener) {
        this.onPenMovedListener = penMovedListener;
    }
    ...
    private void onTouchMoveEvent(float x, float y) {
        ...
        // notify that pen has moved on the canvas
        if(onPenMovedListener!=null)
            onPenMovedListener.penMoved();
