...
import com.sftelehealth.doctor.data.model.Timers;
...
public class UpdateDoctorResponse {
    ...
    public Integer getWorkingSince() {
        return workingSince;
    }

    public void setWorkingSince(Integer workingSince) {
